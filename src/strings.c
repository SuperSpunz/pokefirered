...
const u8 gText_ThrowInPremierBallEN[] = _("プレミアボ-ル 1コ\nおまけ しておきますね!{PAUSE_UNTIL_PRESS}");
const u8 gText_ThrowInPremierBallsEN[] = _("I'll throw in some Premier Balls, too.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ChoosePokemon[] = _("Choose for {STR_VAR_2}.");
