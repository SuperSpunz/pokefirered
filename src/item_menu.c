...
enum ItemSortType
{
    ...
    ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
	ITEM_TYPE_HELD_ITEM,
	ITEM_TYPE_GEM,
	ITEM_TYPE_PLATE,
	ITEM_TYPE_MEMORY,
...
static const u16 sItemsByType[ITEMS_COUNT] =
{
    ...
    */
    ...
    [ITEM_SILK_SCARF] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
    [ITEM_BLACK_BELT] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
    [ITEM_SHARP_BEAK] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
    [ITEM_POISON_BARB] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
    [ITEM_SOFT_SAND] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
    [ITEM_HARD_STONE] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
    [ITEM_SILVER_POWDER] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
    [ITEM_SPELL_TAG] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
    [ITEM_METAL_COAT] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
    [ITEM_CHARCOAL] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
    [ITEM_MYSTIC_WATER] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
    [ITEM_MIRACLE_SEED] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
    [ITEM_MAGNET] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
    [ITEM_TWISTED_SPOON] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
    [ITEM_NEVER_MELT_ICE] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
    [ITEM_DRAGON_FANG] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
    [ITEM_BLACK_GLASSES] = ITEM_TYPE_HELD_ITEM_TYPE_BOOST,
